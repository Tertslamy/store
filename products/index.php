...
<body>
    <div class="header">
        <h1>
            ...
            ម៉ាស៊ីន Tablets និង កុំព្យូទ័រ
        </h1>
        <div class="header-icons">
            <a href="add_product.php" class="header-icon" title="បញ្ចូលផលិតផលថ្មី">
                <i class="fas fa-plus"></i>
            </a>
            <a href="#" class="header-icon" title="ការកំណត់">
                <i class="fas fa-cog"></i>
            </a>
            <a href="#" class="header-icon" title="ព័ត៌មាន">
